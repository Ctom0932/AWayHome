...
#Game over screen
go = Image("12.jpg",game)
go.resizeTo(900,800)
celebration = Image("celebration.jpg",game)
celebration.resizeTo(900,800)
con = Image("congratulation.png",game)
...
while not game.over and mc.health > 0:
    ...
    game.drawText("Health:" + str(mc.health),mclvl4.x,mclvl4.y + 75)
    game.update(30)
